...
function CardHome() {
  return (
    <>
      <div className="border-divider-light relative z-10 flex-1 rounded-2xl border bg-white dark:border-divider-dark dark:bg-slate-900">
        <div className="border-divider-light absolute inset-x-0 inset-y-8 z-[-1] border-t dark:border-divider-dark"></div>
        <div className="border-divider-light absolute inset-y-0 inset-x-8 z-[-1] border-l dark:border-divider-dark"></div>
