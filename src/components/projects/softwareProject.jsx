  ...
  return (
    <>
      <a href={projectLink} className="group">
        <div className="border bg-table-color/10 bg-opacity-5 backdrop-blur-xs group-hover:bg-table-color group-hover:bg-opacity-50 group-hover:scale-105 group-hover:transition-all group-hover:duration-800 group-hover:ease-linear border-text-general border-opacity-25 rounded-2xl font-sans">
          <div className="p-4">
            <div>
