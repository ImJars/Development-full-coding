  ...
  return (
    <>
      <a href={projectLink} className="group">
        <div className="border bg-table-color group-hover:bg-table_activate group-hover:bg-opacity-80 group-hover:-translate-y-1 group-hover:transition-all group-hover:duration-800 group-hover:ease-linear border-text-general border-opacity-20 rounded-lg font-sans">
          <div className="p-4">
            <div>
