                  ...
                  <div ref={refAnimateScroll}>
                    <div ref={refAnimate} className="mt-10">
                      ...
                      <h2 className="text-text-general text-base tracking-wide mt-5">
                        I love creating something that is clean and
                        minimalistic, attractive and has value, and of course,
                        easy to use.
                      </h2>
                    ...
                    <div className="text-text-general text-base tracking-wide mt-5">
                      <p>
                        ...
                        landing pages. So, what tools did I feel comfortable
                        using during the website creation?
                      </p>
                    </div>
                    <div>
                      <div ref={refAnimate2}>
